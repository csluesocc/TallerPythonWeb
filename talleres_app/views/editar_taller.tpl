...
<html lang="es">
  <head>
    ...
    <title>Editar Taller | CSLUESOCC</title>
    ...
    <div class="container">
      ...
      % else:
        <div class="alert alert-info">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
      	     <span class="glyphicon glyphicon-info-sign"></span> <strong>¡Atención!</strong> 
	     Tenga en cuenta que los cambios que haga seran permanentes a menos que decida editar de nuevo el taller.
        </div>
      % end 
      <div>
	<!--formulario -->
	<form action="/update" method="post" class="form-horizontal" role="form" name="tallerForm" id="tallerForm">
	  <fieldset>		
	    <!-- Text input-->
		...
		<input id="titulo" name="titulo" type="text" placeholder="Titulo" 
		       class="form-control" required="" value="{{taller['titulo']}}">
	      </div>
	    </div>
		...
		<input id="tallerista" name="tallerista" type="text" 
		       placeholder="Tallerista" class="form-control" required="" value="{{taller['tallerista']}}">		      
	      </div>
	    </div>
		...
		<textarea id="descripcion" name="descripcion" class="form-control" rows="3" 
			  placeholder="Detalles del taller..." >{{taller['descripcion']}}</textarea>
	      </div>
	    </div>
		...
		<input id="img" name="img" type="text" placeholder="http://url.com/imagen.png" 
		       class="form-control" required="" value="{{taller['img']}}">		     
	      </div>
	    </div>
		...
		<div class="row">
		  <div class="col-sm-10">
		    <input id="fecha" name="fecha" type="text" placeholder="2014-01-16" 
			   class="form-control" data-format="yyyy-MM-dd" required="" value="{{taller['fecha']}}" readonly>
		  </div> 
		  <div class="col-sm-1">			 
		...
		<div class="row">
		  <div class="col-sm-10">
		    <input id="hora" name="hora" type="text" placeholder="20:30:00" 
			   class="form-control" data-format="hh:mm:ss" required="" value="{{taller['hora']}}" readonly>		      
		  </div>
		  <div class="col-sm-1">
	  ...
	  <input type="hidden" name="link" value="{{taller['link']}}">
	   <div class="form-group">
